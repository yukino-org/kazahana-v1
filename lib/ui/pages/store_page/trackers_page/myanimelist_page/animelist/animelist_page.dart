...
class Page extends StatelessWidget {
  ...
  Widget build(final BuildContext context) => ProfilePage(
        ...
        tabs: MyAnimeListAnimeListStatus.values
            .map(
        ...
        getMediaList: (final PageTab tab) {
          final MyAnimeListAnimeListStatus status =
              tab.data as MyAnimeListAnimeListStatus;

          return MediaList(
            type: args.type,
            status: status,
            getMediaList: (final int page) async =>
                MyAnimeListAnimeList.getAnimeList(status, page),
            getItemCard: (final BuildContext context, final dynamic _item) {
              final MyAnimeListAnimeList x = _item as MyAnimeListAnimeList;
              x.applyChanges();
